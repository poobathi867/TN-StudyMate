...
import { Trophy, ExternalLink, Download, FileText, Info, Award } from 'lucide-react';

export default function ResultsPage() {
  const { studentClass } = useAuth();

  const resultUrl = studentClass === '12'
    ? 'https://tnresults.nic.in/rdtpex.htm'
    : 'https://tnresults.nic.in/rdclex.htm';
  ...
  return (
    <div className="page-container">
      ...
      >
        <h1 className="page-title">📊 Check Results</h1>
        <p className="page-subtitle">Access your TN Board public exam results</p>
      </motion.div>
      ...
      >
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-6)', maxWidth: 480, margin: '0 auto var(--space-6)' }}>
          Click the button below to check your {examName} results on the official Tamil Nadu results portal.
        </p>
        ...
        <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)', marginTop: 'var(--space-4)' }}>
          Opens tnresults.nic.in in a new tab
        </p>
      </motion.div>
      ...
      >
        ...
        <div style={{ display: 'grid', gap: 'var(--space-3)' }}>
          <a
            href="https://tnresults.nic.in/rdtpex.htm"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://tnresults.nic.in/rdclex.htm"
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-outline"
            style={{ justifyContent: 'flex-start' }}
